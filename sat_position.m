...
%%% inputs
% ---------
% eph_data : array, shape(21,*), ephemeris data for a satellite
% t_rcv : float, receiving GPS time of the week, seconds
% tau: float, transmission time between sat and user, seconds
%
%%% outputs
% ----------
%P = [x; y; z] : array, size(3,*), Position of Satellte in ECEF frame, 
%                meters
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function P = sat_position(eph_data, t_rcv, tau)
    ...
    % (Ref [1] page 3(Note))
    % E_k = M_k + e.*sin(E_k)    % Kepler's Equ for the eccentric anomaly E_k % rad
    E_old = M_k;
